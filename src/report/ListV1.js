...
class Screen extends React.Component {
  ...
  renderSale() {
    return <ReportSale navigation={this.props.navigation}/>
  }

  renderLoan() {
    return <ReportLoan navigation={this.props.navigation}/>
  }

  render() {
    return (
      <ScrollableTabView>
        <View style={{flex:1}} tabLabel={L('TRANSACTIONS')}>{this.renderSale()}</View>
