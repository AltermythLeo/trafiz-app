    ...
    return(
      <View style={{backgroundColor:'white', elevation:1, padding:10, paddingRight:15, paddingBottom:8, borderBottomColor:'gainsboro', borderBottomWidth:10}}>
          ...
          <View style={{flexDirection:'row',justifyContent:'space-between'}}>
            <Text style={{color:lib.THEME_COLOR_BLACK, fontSize : lib.THEME_FONT_MEDIUM}}>{L('Buy')+' :'}</Text>
            <Text style={{color:lib.THEME_COLOR_RED, fontSize:lib.THEME_FONT_MEDIUM}}>{lib.toPrice(item.income)} kg</Text>
          </View>
          <Text/>
          <View style={{flexDirection:'row',justifyContent:'space-between'}}>
            <Text style={{color:lib.THEME_COLOR_BLACK, fontSize : lib.THEME_FONT_MEDIUM}}>{L('Sell')+' :'}</Text>
            <Text style={{color:lib.THEME_COLOR_GREEN, fontSize:lib.THEME_FONT_MEDIUM}}>{lib.toPrice(item.expense)} kg</Text>
          </View>
          <Text/>
          ...
          <View style={{flexDirection:'row',justifyContent:'space-between'}}>
            <Text style={{fontWeight:'bold', color:lib.THEME_COLOR_BLACK, fontSize : lib.THEME_FONT_MEDIUM}}>{L('Difference') + ' :'}</Text>
            <Text style={{fontWeight:'bold', color:item.total <= 0 ? lib.THEME_COLOR_GREEN : lib.THEME_COLOR_RED, fontSize : lib.THEME_FONT_MEDIUM}}>
              {lib.toPrice(item.total)} kg
            </Text>
          </View>
      </View>
    );
